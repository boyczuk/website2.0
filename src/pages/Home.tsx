...
const projects: Project[] = [
    { id: 1, name: "Tangle-chat", desc: "A decentralized chat app.", skills: "Javascript, Go, React, PostgreSQL, AWS EC2, Docker", image: tangleChatImg },
    { id: 2, name: "Arcade-Rate", desc: "A game rating platform.", skills: "TypeScript, Node.js, React, Firebase", image: arcadeRateImg },
    { id: 3, name: "Black Market - Unity game", desc: "A 2D crime game.", skills: "C#, Unity, 2D Game Development", image: blackMarketImg },
    { id: 4, name: "The World of Yasu", desc: "An online world exploration game.", skills: "TypeScript, React, Firebase, TailwindCSS", image: yasuImg },
    { id: 5, name: "Proxima Command", desc: "An Arduino-based space command project.", skills: "Python, Pygame, CircuitPython, Arduino", image: proximaImg },
    { id: 6, name: "Flappy Bird Reinforcement Learning", desc: "AI plays Flappy Bird using RL.", skills: "Python, PyTorch, OpenAI Gym, NumPy, Pandas", image: flappyBirdImg },
    { id: 7, name: "Equities Trading Bot", desc: "Automated trading bot.", skills: "Python, QuantConnect, Jupyter Notebook, NumPy, Pandas, Scikit-learn", image: quantImg },
    { id: 8, name: "QBNB - Airbnb Clone", desc: "A clone of Airbnb.", skills: "Python, Flask, MongoDB, Pytest, Linux, Docker", image: qbnbImg },
    { id: 9, name: "UAV Detection", desc: "Machine Learning model for UAV detection.", skills: "Python, YOLOv5, OpenCV", image: uavImg }
];
            ...
            <div id='intro' className='intro'>
                <div className='big-intro-text'>
                    ...
                    <div className='small-intro-text'>
                        ...
                        I love building things! Something something about web applications, mention specific languages I like using,
                        and what I am currently learning! TypeScript, Python, React, and Go.
                    </div>
                </div>
